...
export default {
  ...
  mounted() {
    ...
    this.ruleForm.name = this.$route.query.teachData.name;
    ...
    this.ruleForm.class = [this.$route.query.teachData.class];
    ...
    methods: {
      ...
      cancel(){
      this.$router.push("/edumenus/teachermanage");
    },
