<template>
  <div class="stucheck">
    <div class="title">
      <router-link to="" tag="span" class="stumanage"
        >学生管理</router-link
      >
      <span>></span>
      <span>学生信息</span>
      <el-row>
        ...
        :disabled="stuData.state === '激活' ? false : true">结课</el-button>
        <el-button @click="disable(1)" size="medium"
        :disabled="stuData.state === '激活' ? true : false">激活</el-button>
      </el-row>
    </div>
    <div class="content">
...
export default {
  ...
  methods: {
    ...
    axios
      .get("/api/student/studentcheck", obj)
      .then((response) => {
